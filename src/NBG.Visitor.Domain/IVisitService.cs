...
namespace NBG.Visitor.Domain
{
    public interface IVisitService
    {
        ...
        Task AddVisit(DateTime? start, string contactPerson, string company, string firstName, string lastName, string phoneNumber, string email = null, VisitStatusDto status = VisitStatusDto.VISIT_ACTIVE);
